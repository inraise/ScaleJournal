...
class SearchedNewsUseCase @Inject constructor(private val domainRepositoryImpl: DomainRepositoryImpl) :
    BaseUseCase<NewsModel>() {
    override suspend fun invoke(value1: Any?, value2: Any?): NewsModel =
        domainRepositoryImpl.getSearchedNews(value1.toString(), value2.toString())
}